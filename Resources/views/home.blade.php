<div>
    <div class="hero">
      <div class="hero-slide">
        <div
          class="img overlay"
          style="background-image: url({{ $_theme->asset('pub_theme::images/hero_bg_3.jpg') }})"
        ></div>
        <div
          class="img overlay"
          style="background-image: url({{ $_theme->asset('pub_theme::images/hero_bg_2.jpg') }})"
        ></div>
        <div
          class="img overlay"
      ...
      <div class="container">
        <div class="row mb-5 align-items-center">
          ...
          <div class="col-lg-6 text-lg-end">
            <p>
              <a
                href="{{ $this->url('index',['record' => 'property']) }}"
                target="_blank"
          ...
          <div class="col-12">
            <div class="property-slider-wrap">
              <div class="property-slider">
                  @foreach($_theme->getReProperties() as $property)
      ...
      <div class="container">
        ...
        <div class="testimonial-slider-wrap">
          <div class="testimonial-slider">
            @foreach($_theme->getReTestimonials() as $testimonial)
                <x-re.testimonial :testimonial="$testimonial" />
            @endforeach
          </div>
        </div>
      </div>
    ...
    <div class="section section-5 bg-light">
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          ...
          <div class="row">
            @foreach($_theme->getReAgents() as $agent)
                <x-re.agent :agent="$agent" />
            @endforeach
          </div>
      </div>
    </div>
